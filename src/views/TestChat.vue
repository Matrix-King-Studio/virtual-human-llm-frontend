<template>
    <div class="main">
        ...
        <el-button @click="deletecontent" style="position: absolute; right: 10px; top: 10px">清空对话</el-button>
        <div class="box">
                        ...
                        <li v-for="(item, index) in info" :key="index" :class="{
                            ...
                            <div v-if="item.role === 'virtual_human'" class="optionIcon">
                                ...
                                <svg t="1702787092946" style="cursor: pointer; margin-left: 7px" class="icon"
                                    viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4313"
                                    width="15" height="20" @click="abstractBoxShow(index)">
                                    <path
                                ...
                                <svg t="1702787756112" style="cursor: pointer; margin-left: 7px" class="icon"
                                    viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5328"
                                    width="20" height="20" @click="newsBoxShow(index)">
                                    <path
...
onMounted(async () => {
    ...
    try {
        const registrationResponse = await registration(userID, "2889015731@qq.com", "123456", "123456");
        console.log(userID + "OOOOOO");

        const signResponse = await sign(userID, "123456");
        totast("登陆成功！！欢迎！！", "success");
        setToken(signResponse.key);
