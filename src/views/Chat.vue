...
<!--									</div>-->
          ...
          <div class="function">
            ...
            <div class="ipt">
              <div class="col-xs-12">
                <textarea id="chatInput" class="form-control" rows="1" placeholder="请输入想提问的问题"></textarea>
              </div>
...
body{
  background:linear-gradient(30deg,rgba(113,72,248,.33),rgba(104,157,255,.12) 50%,rgba(166,112,235,.12));
    color: var(--UI-FG-0);
}
</style>